...
import { AppBar, Avatar, Box, Divider, ListItemIcon, ListItemText, Menu, MenuItem, Stack, Toolbar, Typography, useScrollTrigger } from "@mui/material";
						...
						<Stack direction={"row"} height="64px" >
							...
							{user.name != undefined ? (
								<RightOptionBox>
									...
									<Avatar src={`http://localhost:3001/uploads/profiles/${user.profileImg}`} onClick={(e) => { handleClick(e) }} />
								</RightOptionBox>
							) : (
